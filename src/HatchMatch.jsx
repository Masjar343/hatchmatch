...
const DB = [
  ...
  // ─── CADDISFLIES ─────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Elk Hair Caddis (Olive)',style:'Dry',sizes:'12–18',hook:'Dry fly',confidence:'High',weight:'None',tip:"Olive body for the spring Mother's Day caddis hatch (Brachycentrus). One of the most important spring hatches in the West and East.",photo:'https://norrik.com/wp-content/uploads/2024/07/black-caddis-fly-small.jpg'},
      ...
      {name:'LaFontaine Sparkle Pupa (Amber)',style:'Pupa/Wet',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'None',tip:'Amber/tan for summer caddis pupa. Dead drift or swing under the surface during evening caddis flights.',photo:'https://norrik.com/wp-content/uploads/2024/07/caddis-emerger-small.jpg'},
  ...
  async function identify() {
    ...
    try {
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({ model: 'claude-sonnet-4-20250514', max_tokens: 1200, messages: [{ role: 'user', content: [{ type: 'image', source: { type: 'base64', media_type: mime, data: b64 } }, { type: 'text', text: prompt }] }] })
      });
