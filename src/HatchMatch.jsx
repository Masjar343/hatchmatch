...
const DB = [
  // ─── MAYFLIES ────────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:'Pheasant Tail Nymph',style:'Nymph',sizes:'16–20',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'Dead drift along bottom. Add a midge dropper in winter. One of the most universally effective nymphs ever tied.',photo:'https://norrik.com/wp-content/uploads/2024/07/pheasant-tail-nymph.jpg'},
      {name:'RS2',style:'Emerger',sizes:'18–22',hook:'Standard nymph',confidence:'High',weight:'Unweighted',tip:'Fish in the film on a greased leader. Essential on the South Platte.',photo:'https://norrik.com/wp-content/uploads/2024/07/rs2-emerger.jpg'},
      {name:'Flashback BWO',style:'Nymph',sizes:'16–22',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'Flash back triggers strikes in the water column during emergence. Fish on a dead drift 12–18 inches below an indicator. One of the most productive BWO sub-surface patterns.',photo:'https://norrik.com/wp-content/uploads/2024/07/blue-winged-olive-nymph-pattern.jpg'},
      {name:'Sparkle Dun (Olive)',style:'Dry',sizes:'18–22',hook:'Dry fly',confidence:'High',weight:'None',tip:'Olive body for classic spring/fall BWOs. Trim wing to match local insects. Shuck trailing in the film seals the deal.',photo:'https://norrik.com/wp-content/uploads/2024/07/sparkle-dun.jpg'},
      {name:'Sparkle Dun (Gray/Dark)',style:'Dry',sizes:'18–22',hook:'Dry fly',confidence:'High',weight:'None',tip:'Gray or near-black body for winter BWOs and dark-colored Baetis. On overcast winter days, the darker version often outfishes olive. Always check the naturals.',photo:'https://norrik.com/wp-content/uploads/2024/07/blue-winged-olive-dry-fly-pattern.jpg'},
      {name:'Parachute Adams',style:'Dry',sizes:'14–22',hook:'Dry fly',confidence:'High',weight:'None',tip:"The world's most versatile dry fly. Works during BWO, caddis, and midge hatches. Never leave home without it.",photo:'https://norrik.com/wp-content/uploads/2024/07/parachute-adams.jpg'},
      {name:'Blue Dun',style:'Dry',sizes:'16–22',hook:'Dry fly',confidence:'High',weight:'None',tip:'One of the oldest trout flies in existence. Blue/gray dun hackle perfectly matches the slate-gray wings of the Baetis dun. Deadly on eastern limestone streams and tailwaters where trout have seen every modern pattern. Fish dead drift on a fine tippet.',photo:'https://norrik.com/wp-content/uploads/2024/07/blue-quill-dry-fly.jpg'},
      {name:'Copper John',style:'Nymph',sizes:'14–20',hook:'Standard nymph',confidence:'High',weight:'Tungsten bead',tip:'Heavy wire body sinks fast. Deadly attractor nymph for both stonefly and mayfly imitation. Fish on the point in a two-fly rig.',photo:'https://norrik.com/wp-content/uploads/2024/07/copper-johns-nymph.jpg'},
      {name:'Rusty Spinner',style:'Spinner',sizes:'18–22',hook:'Dry fly',confidence:'High',weight:'None',tip:'Fish flat in the film at dusk.',photo:'https://norrik.com/wp-content/uploads/2024/07/rusty-spinner.jpg'}
    ]
  },
  {
  ...
  },
  {
    ...
    topFlies:[
      ...
      {name:'Parachute Sulphur',style:'Dry',sizes:'14–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Match the local color — lemon yellow on some rivers, orange-yellow on others. Evening hatch, often at last light. 5X tippet minimum.',photo:'https://norrik.com/wp-content/uploads/2024/07/pmd-parachute.jpg'},
      {name:'Sulphur Comparadun',style:'Dry',sizes:'16–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Low-riding deer hair wing. Perfect for selective fish on flat spring creek water. The toughest sulphur situations call for this over a parachute.',photo:'https://norrik.com/wp-content/uploads/2024/07/royal-wulff.jpg'},
      {name:'Sulphur Cripple',style:'Emerger',sizes:'16–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Hang the tail in the film. Trout lock onto cripples during heavy sulphur hatches — often outfishes the dun pattern 5-to-1.',photo:'https://norrik.com/wp-content/uploads/2024/07/cripple-fly.jpg'},
      {name:'Klinkhammer',style:'Emerger',sizes:'14–18',hook:'Klinkhammer/emerger',confidence:'High',weight:'None',tip:'Hook bend hangs below the film, parachute post above. Deadly when trout are taking emergers just below the surface. Works for sulphurs, PMDs, caddis — one of the most versatile emerger patterns ever tied.',photo:'https://norrik.com/wp-content/uploads/2024/07/soft-hackle-emerger.jpg'},
      ...
      {name:'Hares Ear Nymph',style:'Nymph',sizes:'14–16',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'Fish before the evening hatch. Sulphur nymphs are active crawlers — a gold bead Hares Ear in riffles is hard to beat.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-nymph.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'Parachute Green Drake',style:'Dry',sizes:'10–14',hook:'Dry fly',confidence:'High',weight:'None',tip:'Big fly, big trout. Fish in foam lines during hatch.',photo:'https://norrik.com/wp-content/uploads/2024/07/green-drake-fly.jpg'},
      {name:'Olive Hares Ear',style:'Nymph',sizes:'10–14',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'Fish heavy weeks before hatch.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-nymph.jpg'},
      {name:'Green Drake Cripple',style:'Emerger',sizes:'10–14',hook:'Dry fly',confidence:'High',weight:'None',tip:'Fish in the film during the hatch when trout are ignoring the adult. A crippled dun stuck in the shuck is the easiest meal on the water — trout key on these during heavy Green Drake emergences.',photo:'https://norrik.com/wp-content/uploads/2024/07/cripple-fly.jpg'},
  ...
  },
  {
    ...
    topFlies:[
      ...
      {name:'Trico Spinner',style:'Spinner/Dry',sizes:'20–26',hook:'Dry fly',confidence:'High',weight:'None',tip:'Fish during the spinner fall. Use 6X or 7X tippet. Let the fly drift without drag — trout are extremely selective.',photo:'https://norrik.com/wp-content/uploads/2024/07/classic-mayfly-emerger.jpg'},
      ...
      {name:'Pheasant Tail Nymph',style:'Nymph',sizes:'20–24',hook:'Midge/Nymph',confidence:'Med',weight:'Unweighted',tip:'Fish tiny PT before the spinner fall begins.',photo:'https://norrik.com/wp-content/uploads/2024/07/pheasant-tail-nymph.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'CDC Emerger',style:'Emerger',sizes:'12–16',hook:'Dry fly',confidence:'High',weight:'None',tip:'CDC feather in the film imitates a dun struggling to emerge. Fish during the Hendrickson hatch when trout are refusing dry flies. The soft CDC wing creates a lifelike footprint that fooling even the wariest fish.',photo:'https://norrik.com/wp-content/uploads/2024/07/hendrickson-emerger.jpg'},
      {name:'Parachute Hendrickson',style:'Dry',sizes:'12–16',hook:'Dry fly',confidence:'High',weight:'None',tip:'Classic eastern dry fly. Fish during the afternoon hatch in April–May.',photo:'https://norrik.com/wp-content/uploads/2024/07/hendrickson-dry-fly.jpg'},
      {name:'Red Quill',style:'Dry',sizes:'12–16',hook:'Dry fly',confidence:'High',weight:'None',tip:'Traditional wet fly also works well swung downstream.',photo:'https://norrik.com/wp-content/uploads/2024/07/red-quill-fly.jpg'},
      {name:'Soft Hackle Pheasant Tail',style:'Wet/Emerger',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'Unweighted',tip:'Swing across and down during emergence. Deadly during March Brown hatches.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-soft-hackle.jpg'},
      {name:'Hendrickson Nymph',style:'Nymph',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'The Hendrickson nymph is an active swimmer. Fish in the days leading up to the hatch with a jigging retrieve in slow pools and runs.',photo:'https://norrik.com/wp-content/uploads/2024/07/hendrickson-nymph.jpg'},
      {name:'Rusty Spinner',style:'Spinner',sizes:'12–16',hook:'Dry fly',confidence:'High',weight:'None',tip:'The Hendrickson spinner fall happens at dusk — often the best fishing of the day. Spent wings flat in the film. Fish with 5X or 6X and a dead drift.',photo:'https://norrik.com/wp-content/uploads/2024/07/rusty-spinner.jpg'},
      {name:'Hares Ear Nymph',style:'Nymph',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'Fish this before the hatch begins. Deadliest early spring nymph.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-nymph.jpg'}
    ]
  },
  // ─── CADDISFLIES ─────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Elk Hair Caddis (Olive)',style:'Dry',sizes:'12–18',hook:'Dry fly',confidence:'High',weight:'None',tip:"Olive body for the spring Mother's Day caddis hatch (Brachycentrus). One of the most important spring hatches in the West and East.",photo:'https://norrik.com/wp-content/uploads/2024/07/caddis-emerger.jpg'},
      {name:'LaFontaine Sparkle Pupa (Green)',style:'Pupa/Wet',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'None',tip:'Bright green body for spring caddis. Fish just below the surface on a swing. The most important spring caddis pupa pattern.',photo:'https://norrik.com/wp-content/uploads/2024/07/caddis-pupa-nymph.jpg'},
      {name:'LaFontaine Sparkle Pupa (Amber)',style:'Pupa/Wet',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'None',tip:'Amber/tan for summer caddis pupa. Dead drift or swing under the surface during evening caddis flights.',photo:'https://norrik.com/wp-content/uploads/2024/07/adams-fly.jpg'},
      {name:'X-Caddis',style:'Dry/Emerger',sizes:'14–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Z-lon shuck hangs in the film. Deadly for selective fish during heavy caddis hatches. Carry in tan and olive.',photo:'https://norrik.com/wp-content/uploads/2024/07/elk-hair-emerger.jpg'},
      {name:'Frenchie',style:'Nymph',sizes:'12–18',hook:'Jig nymph',confidence:'High',weight:'Tungsten bead',tip:'Euro nymphing staple. Hot spot pink/orange collar triggers strikes. Year-round caddis larva imitation.',photo:'https://norrik.com/wp-content/uploads/2024/07/perdigon-nymph.jpg'},
      ...
      {name:'Goddard Caddis',style:'Dry',sizes:'10–14',hook:'Dry fly',confidence:'High',weight:'None',tip:'Spun deer hair rides high and skates beautifully in fast water. Excellent searching pattern when you can\'t see the fly.',photo:'https://norrik.com/wp-content/uploads/2024/07/goddard-caddis-fly.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'Cased Caddis',style:'Nymph/Larva',sizes:'6–10',hook:'Heavy nymph',confidence:'High',weight:'Tungsten bead',tip:'Dead drift deep along the bottom. October Caddis are case-builders — they drag rock and stick cases along the riverbed all summer and fall. Fish before the hatch with a heavy anchor fly.',photo:'https://norrik.com/wp-content/uploads/2024/07/girdle-bug-fly.jpg'},
      {name:'Orange Elk Hair Caddis',style:'Dry',sizes:'8–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'Burnt orange foam body, ginger hackle, dark deer hair wing. Skate and twitch at dusk — October Caddis egg-laying is active, not passive.',photo:'https://norrik.com/wp-content/uploads/2024/07/october-caddis-fly.jpg'},
      ...
      {name:'Goddard Caddis (Orange)',style:'Dry',sizes:'8–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'Spun deer hair head creates water disturbance when skated. The wake triggers reaction strikes from large fish.',photo:'https://norrik.com/wp-content/uploads/2024/07/goddard-caddis-fly.jpg'}
    ]
  },
  // ─── STONEFLIES ──────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:'Chubby Chernobyl',style:'Dry',sizes:'4–8',hook:'Dry fly',confidence:'High',weight:'None',tip:'Foam body floats all day. Doubles as a hopper indicator for a dropper rig.',photo:'https://norrik.com/wp-content/uploads/2024/07/chubby-chernobyl.jpg'},
      {name:'Sofa Pillow',style:'Dry',sizes:'2–6',hook:'Dry fly',confidence:'High',weight:'None',tip:'Classic big-water salmonfly dry. Slap it down near banks.',photo:'https://norrik.com/wp-content/uploads/2024/07/salmon-dry-fly-pattern.jpg'},
      {name:'Kaufmanns Stone',style:'Nymph',sizes:'2–6',hook:'Heavy nymph',confidence:'High',weight:'Lead wire',tip:'Fish deep along the bottom before the hatch peaks. The most realistic salmonfly nymph.',photo:'https://norrik.com/wp-content/uploads/2024/07/black-stonefly-nymph.jpg'},
      {name:'PMX (Purple Haze)',style:'Dry/Attractor',sizes:'4–10',hook:'Dry fly',confidence:'High',weight:'None',tip:"Parachute Madam X — one of the most effective big dry flies ever tied. The purple version is a Yellowstone/Madison staple. Fish it as a single or with a nymph dropper. Trout crush it even between hatches.",photo:'https://norrik.com/wp-content/uploads/2024/07/chubby-chernobyl.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'Yellow Stimulator',style:'Dry',sizes:'6–14',hook:'Dry fly',confidence:'High',weight:'None',tip:'Year-round attractor. Dead drift or skitter. Great hopper-dropper indicator.',photo:'https://norrik.com/wp-content/uploads/2024/07/golden-stonefly-nymph.jpg'},
      ...
      {name:'Royal Wulff',style:'Dry',sizes:'10–16',hook:'Dry fly',confidence:'High',weight:'None',tip:"One of fly fishing's most famous attractors. Visible in fast water. Works when nothing is hatching.",photo:'https://norrik.com/wp-content/uploads/2024/07/royal-wulff.jpg'}
    ]
  },
  // ─── MIDGES ──────────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:'Zebra Midge',style:'Pupa/Nymph',sizes:'18–24',hook:'Midge',confidence:'High',weight:'Beadhead',tip:'Fish 18 inches below indicator in tailwaters. The single most important tailwater fly.',photo:'https://norrik.com/wp-content/uploads/2024/07/gray-midge-emerger.jpg'},
      {name:'Mercury Midge',style:'Pupa',sizes:'18–24',hook:'Midge',confidence:'High',weight:'Clear bead',tip:'Glass bead catches light. Exceptional on the South Platte and Bighorn.',photo:'https://norrik.com/wp-content/uploads/2024/07/parachute-midge.jpg'},
      {name:"Griffith's Gnat",style:'Dry',sizes:'18–24',hook:'Dry fly',confidence:'High',weight:'None',tip:'Mimics a midge cluster on the surface. Essential tailwater dry fly.',photo:'https://norrik.com/wp-content/uploads/2024/07/griffiths-gnat.jpg'},
      {name:'Brassie',style:'Larva',sizes:'18–24',hook:'Midge',confidence:'High',weight:'Wire body',tip:'Copper wire body is heavy and segmented. Pair with a Zebra Midge dropper.',photo:'https://norrik.com/wp-content/uploads/2024/07/scud-nymph-fly.jpg'},
  ...
  // ─── TERRESTRIALS ────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:"Dave's Hopper",style:'Dry',sizes:'6–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'Slap hard against the bank. Pause 3–5 seconds then twitch.',photo:'https://norrik.com/wp-content/uploads/2024/07/hopper-fly.jpg'},
      {name:'Chubby Chernobyl',style:'Dry/Attractor',sizes:'6–10',hook:'Dry fly',confidence:'High',weight:'None',tip:'Best indicator for a dropper rig. Float all day without reapplying floatant.',photo:'https://norrik.com/wp-content/uploads/2024/07/chubby-chernobyl.jpg'},
      {name:'Parachute Hopper',style:'Dry',sizes:'8–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'High-vis parachute post. Excellent on flat-water meadow stretches.',photo:'https://norrik.com/wp-content/uploads/2024/07/hopper-fly.jpg'},
      {name:'Fat Albert',style:'Dry/Attractor',sizes:'6–10',hook:'Dry fly',confidence:'High',weight:'None',tip:'Foam body with rubber legs. Imitates hoppers, crickets, and large stoneflies. Great hopper-dropper indicator.',photo:'https://norrik.com/wp-content/uploads/2024/07/chubby-chernobyl.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'Foam Ant',style:'Dry',sizes:'14–20',hook:'Dry fly',confidence:'High',weight:'None',tip:'Simple but deadly. Works on pressured fish that reject hoppers. High-vis foam post helps sighting.',photo:'https://norrik.com/wp-content/uploads/2024/07/chernobyl-ant.jpg'},
      {name:'Flying Ant',style:'Dry',sizes:'14–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'During ant flights, this fly outfishes everything. Keep a few winged ant patterns in your box at all times.',photo:'https://norrik.com/wp-content/uploads/2024/07/chernobyl-ant.jpg'},
      {name:'Foam Beetle',style:'Dry',sizes:'12–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Drift along banks and foam lines. Foam body is virtually unsinkable. Works throughout the season.',photo:'https://norrik.com/wp-content/uploads/2024/07/beetle-fly.jpg'},
      {name:'Deer Hair Beetle',style:'Dry',sizes:'12–18',hook:'Dry fly',confidence:'High',weight:'None',tip:'Spun deer hair creates a realistic low-riding profile. More subtle than foam — better for spring creeks and educated fish. Fish tight to grassy banks.',photo:'https://norrik.com/wp-content/uploads/2024/07/chernobyl-ant.jpg'},
      {name:'CDC Ant',style:'Dry',sizes:'16–20',hook:'Dry fly',confidence:'High',weight:'None',tip:'For selective fish in still water and spring creeks. CDC wing provides a realistic footprint in the film.',photo:'https://norrik.com/wp-content/uploads/2024/07/ant-fly-pattern.jpg'}
    ]
  },
  // ─── STREAMERS ───────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Muddler Minnow',style:'Streamer',sizes:'4–10',hook:'Streamer',confidence:'High',weight:'Optional cone',tip:'Imitates sculpin and baitfish. Fish dead drift, strip, or swing. One of the most historically proven streamers ever tied.',photo:'https://norrik.com/wp-content/uploads/2024/07/muddler-minnow-fly.jpg'},
      {name:'Clouser Minnow',style:'Streamer',sizes:'4–8',hook:'Streamer',confidence:'High',weight:'Dumbbell eyes',tip:'Weighted eyes cause a jig action. Deadly for trout, bass, and saltwater fish. Fish with fast strips.',photo:'https://norrik.com/wp-content/uploads/2024/07/clouser-minnow.jpg'}
    ]
  },
  {
    ...
    topFlies:[
      {name:'Zonker',style:'Streamer',sizes:'4–8',hook:'Streamer',confidence:'High',weight:'Conehead',tip:'Rabbit strip wing breathes with every strip. Deadly for big browns in fall. Fish on the swing in deep runs.',photo:'https://norrik.com/wp-content/uploads/2024/07/articulated-streamer.jpg'},
      {name:'Conehead Muddler',style:'Streamer/Sculpin',sizes:'4–8',hook:'Streamer',confidence:'High',weight:'Brass cone',tip:'Bounce along the bottom in deep runs. Best for large, aggressive fish holding near structure.',photo:'https://norrik.com/wp-content/uploads/2024/07/muddler-minnow-fly.jpg'},
      {name:'Sculpin Helmet',style:'Streamer/Sculpin',sizes:'2–6',hook:'Streamer',confidence:'High',weight:'Lead eyes',tip:'The foam sculpin head pushes water and dives on the strip. One of the most realistic sculpin imitations available. Fish on a short tippet and bounce it along the bottom with strip-pause-strip.',photo:'https://norrik.com/wp-content/uploads/2024/07/sculpin-streamer.jpg'},
      {name:'Egg-Sucking Leech',style:'Streamer',sizes:'4–8',hook:'Streamer',confidence:'High',weight:'Tungsten bead',tip:'Hot pink or orange bead imitates an egg. Dominant pattern for steelhead and large trout in fall.',photo:'https://norrik.com/wp-content/uploads/2024/07/cheech-leech-streamer.jpg'},
      {name:'Sparkle Minnow',style:'Streamer',sizes:'4–8',hook:'Streamer',confidence:'High',weight:'Tungsten bead',tip:'Flash and movement trigger reaction strikes in off-color water and low light. Brown/yellow is the go-to color.',photo:'https://norrik.com/wp-content/uploads/2024/07/kreelex-minnow.jpg'}
    ]
  },
  // ─── ATTRACTOR / SEARCHING NYMPHS ────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Copper John',style:'Nymph',sizes:'12–20',hook:'Standard nymph',confidence:'High',weight:'Tungsten bead',tip:'The most popular trout nymph in the US. Sinks fast, flashes in deep water. Fish on the point with a smaller dropper above.',photo:'https://norrik.com/wp-content/uploads/2024/07/copper-johns-nymph.jpg'},
      {name:'Prince Nymph',style:'Nymph',sizes:'12–18',hook:'Standard nymph',confidence:'High',weight:'Beadhead',tip:'White biot wings suggest an emerging wing. Irresistible searching pattern on freestone rivers. Been catching fish for 80+ years.',photo:'https://norrik.com/wp-content/uploads/2024/07/prince-nymph.jpg'},
      {name:'Royal Wulff',style:'Dry',sizes:'10–16',hook:'Dry fly',confidence:'High',weight:'None',tip:"Float in fast pocket water when no hatch is present. One of fly fishing's most beloved flies — visible and durable.",photo:'https://norrik.com/wp-content/uploads/2024/07/royal-wulff.jpg'},
      {name:'Soft Hackle Pheasant Tail',style:'Wet/Swing',sizes:'12–16',hook:'Standard nymph',confidence:'High',weight:'Unweighted',tip:'Swing across and downstream in riffles at the end of a drift. Imitates emerging caddis, mayflies, and midges all at once.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-soft-hackle.jpg'},
      ...
      {name:'Perdigon',style:'Nymph',sizes:'14–20',hook:'Jig nymph',confidence:'High',weight:'Tungsten bead',tip:'Ultra-thin, fast-sinking Euro nymph. Developed in competition fishing. Gets to the bottom in fast water faster than anything else.',photo:'https://norrik.com/wp-content/uploads/2024/07/perdigon-nymph.jpg'}
    ]
  },
  // ─── EGG PATTERNS ────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:'Glo Bug',style:'Egg',sizes:'8–12',hook:'Egg hook',confidence:'High',weight:'None',tip:'Peach or pink in clear water; chartreuse in stained water. Fish 8–12 inches off the bottom below indicator.',photo:'https://norrik.com/wp-content/uploads/2024/07/salmon-egg-fly.jpg'},
      {name:'Nuke Egg',style:'Egg',sizes:'10–14',hook:'Egg hook',confidence:'High',weight:'None',tip:'Smaller, more realistic profile than a Glo Bug. Excellent on pressured tailwaters where trout see eggs all day.',photo:'https://norrik.com/wp-content/uploads/2024/07/classic-mayfly-emerger.jpg'},
      {name:'Cluster Egg',style:'Egg',sizes:'8–12',hook:'Egg hook',confidence:'High',weight:'None',tip:'Multiple eggs clustered together — imitates a drifting egg mass. Highly visible and productive in stained or off-color water. Deadly for steelhead and Great Lakes trout in fall.',photo:'https://norrik.com/wp-content/uploads/2024/07/salmon-egg-fly.jpg'},
  ...
  // ─── GREEN DRAKE ─────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Comparadun (Olive)',style:'Dry',sizes:'10–14',hook:'Dry fly',confidence:'High',weight:'None',tip:'Low-riding deer hair wing sits in the film. More realistic profile than a parachute. Excellent for selective fish on spring creeks.',photo:'https://norrik.com/wp-content/uploads/2024/07/sparkle-dun.jpg'},
      ...
      {name:'Olive Hare\'s Ear',style:'Nymph',sizes:'10–14',hook:'Standard nymph',confidence:'Med',weight:'Beadhead',tip:'General olive nymph before the hatch. Dead drift deep in the hour before flies appear on the surface.',photo:'https://norrik.com/wp-content/uploads/2024/07/hares-ear-nymph.jpg'}
    ]
  },
  // ─── BROWN DRAKE ─────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      {name:'Brown Drake Comparadun',style:'Dry',sizes:'10–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'Low profile rides the film. Tie with a mottled brown/tan deer hair wing. Fish from last light onward — bring a headlamp.',photo:'https://norrik.com/wp-content/uploads/2024/07/sparkle-dun.jpg'},
      {name:'Brown Drake Spinner',style:'Spinner/Dry',sizes:'10–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'Flat spent wings made of poly or CDC. Fish after dark in calm water. The strike is audible — wait for it before setting.',photo:'https://norrik.com/wp-content/uploads/2024/07/rusty-spinner.jpg'},
      {name:'Brown Drake Parachute',style:'Dry',sizes:'10–12',hook:'Dry fly',confidence:'High',weight:'None',tip:'High-visibility parachute post helps you track the fly in low light. Brown body with ginger hackle. A must-have for the evening hatch.',photo:'https://norrik.com/wp-content/uploads/2024/07/parachute-adams.jpg'}
    ]
  },
  // ─── MARCH BROWN ─────────────────────────────────────────────────────────
  {
    ...
    topFlies:[
      ...
      {name:'Adams (Size 14)',style:'Dry',sizes:'12–16',hook:'Dry fly',confidence:'High',weight:'None',tip:'The Parachute Adams in size 14 is a dead ringer for a March Brown dun. Always have some in your box for the early season.',photo:'https://norrik.com/wp-content/uploads/2024/07/parachute-adams.jpg'}
    ]
  },
  // ─── CALLIBAETIS ─────────────────────────────────────────────────────────
  {
...
function ImgWithFallback({src, flyName='', style, fallbackText='No photo'}) {
  ...
  const urls = useMemo(() => {
    ...
    if (FLY_PHOTOS[key]) {
      list.push(PROXY + encodeURIComponent(FLY_PHOTOS[key]));
      list.push(FLY_PHOTOS[key]); // direct fallback
    }
    if (src) {
      list.push(PROXY + encodeURIComponent(src));
      list.push(src);
    }
    return list;
  }, [src, flyName]);
